...
export default function TestPreparationPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <section className="relative w-full py-20 md:py-32 lg:py-40 bg-gradient-to-br from-primary to-blue-800 text-white overflow-hidden">
        <Image
          src="https://placehold.co/1800x900"
          alt="Test Preparation Background"
          width={1800}
          height={900}
          data-ai-hint="abstract background education"
        ...
        <div className="container relative z-10 flex flex-col lg:flex-row items-center justify-between gap-10 px-4 md:px-6">
          <div className="flex flex-col justify-center space-y-6 text-center lg:text-left lg:w-1/2">
            ...
            <p className="max-w-[700px] text-lg md:text-xl text-gray-100 leading-relaxed mx-auto lg:mx-0">
              Master IELTS, PTE, DET, GRE, and SAT with One93 VISAS expert guidance and proven strategies.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Link
                href="/contact"
                className="inline-flex h-12 items-center justify-center rounded-full bg-accent px-8 text-base font-semibold text-accent-foreground shadow-lg transition-all hover:bg-accent/90 hover:scale-105 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent disabled:pointer-events-none disabled:opacity-50"
                prefetch={false}
              >
                Apply Now
          ...
          <div className="relative w-full lg:w-1/2 flex justify-center lg:justify-end mt-10 lg:mt-0">
            <Image
              ...
              className="rounded-full object-cover shadow-2xl border-4 border-accent animate-float"
            />
          </div>
        </div>
      </section>
      ...
      <section className="w-full py-16 md:py-24 lg:py-32 bg-white">
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
            <span className="inline-block rounded-full bg-accent px-4 py-1 text-sm font-semibold text-accent-foreground uppercase tracking-wide">
              Our Programs
            </span>
            <h2 className="text-4xl font-bold tracking-tight sm:text-5xl text-primary">Courses Offered</h2>
            ...
            {courses.map((course, index) => (
              ...
              >
                <CardHeader className="text-center pb-4">
                  <CardTitle className="text-3xl font-bold text-primary mb-2">{course.title}</CardTitle>
      ...
      <section className="w-full py-16 md:py-24 lg:py-32 bg-gray-100">
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
            ...
            <h2 className="text-4xl font-bold tracking-tight sm:text-5xl text-primary">Start Learning Today!</h2>
            <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
          ...
          <div className="mx-auto grid max-w-4xl items-center gap-12 lg:grid-cols-2">
            <div className="space-y-6">
              <h3 className="text-3xl font-bold text-primary">Learn Anywhere, Anytime</h3>
      ...
      <section className="w-full py-16 md:py-24 lg:py-32 bg-white">
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
            ...
            <h2 className="text-4xl font-bold tracking-tight sm:text-5xl text-primary">Training Process</h2>
            <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="mx-auto grid max-w-6xl items-start gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {uniqueFeatures.map((feature, index) => (
              <Card
                key={index}
                className="flex flex-col items-center text-center p-6 shadow-lg bg-white text-primary rounded-xl transform hover:scale-105 transition-transform duration-300"
              >
